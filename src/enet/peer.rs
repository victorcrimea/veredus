...
use crate::enet::{
    ...
    ENET_PEER_STATE_DISCONNECTED, ENET_PEER_STATE_DISCONNECTING, ENET_PEER_STATE_ZOMBIE, ENetList,
    ENetOutgoingCommand, ENetPeer, Packet, Socket,
...
/// A peer, associated with a [`Host`](`crate::enet::Host`), which may or may not be connected.
///
...
impl<S: Socket> Peer<S> {
    ...
    ///
    /// An [`Event::Disconnect`](`crate::enet::Event::Disconnect`) event will be generated by
    /// [`Host::service`](`crate::enet::Host::service`) once the disconnection is complete.
    ...
    ///
    /// No [`Event::Disconnect`](`crate::enet::Event::Disconnect`) event will be generated. The foreign
    ...
    ///   [`PEER_TIMEOUT_LIMIT`](`crate::enet::consts::PEER_TIMEOUT_LIMIT`) if 0
    /// - `minimum` - the timeout minimum; defaults to
    ///   [`PEER_TIMEOUT_MINIMUM`](`crate::enet::consts::PEER_TIMEOUT_MINIMUM`) if 0
    /// - `maximum` - the timeout maximum; defaults to
    ///   [`PEER_TIMEOUT_MAXIMUM`](`crate::enet::consts::PEER_TIMEOUT_MAXIMUM`) if 0
    ...
    /// [`PEER_PACKET_THROTTLE_SCALE`](`crate::enet::consts::PEER_PACKET_THROTTLE_SCALE`)
    ...
    /// [`ENET_PEER_PACKET_THROTTLE_SCALE`](`crate::enet::consts::PEER_PACKET_THROTTLE_SCALE`) When
    /// the throttle has a value of
    /// [`PEER_PACKET_THROTTLE_SCALE`](`crate::enet::consts::PEER_PACKET_THROTTLE_SCALE`) When
    ...
    ///   value is
    ///   [`PEER_PACKET_THROTTLE_INTERVAL`](`crate::enet::consts::PEER_PACKET_THROTTLE_INTERVAL`)
    ...
    /// The maximum transmission unit of this peer. See [`Host::mtu`](`crate::enet::Host::mtu`).
    #[must_use]
    pub fn mtu(&self) -> u16 {
    ...
    /// [`Host::set_mtu`](`crate::enet::Host::set_mtu`).
    ///
    /// # Errors
    ///
    ...
    /// [`PEER_PACKET_LOSS_SCALE`](crate::enet::consts::PEER_PACKET_LOSS_SCALE).
    #[must_use]
    ...
    ///
    /// This value can be safely unwrapped if a peer was obtained from [`Event`](`crate::enet::Event`).
    #[must_use]
