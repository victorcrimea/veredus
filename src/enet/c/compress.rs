...
use crate::enet::{ENetBuffer, enet_free, enet_malloc};
...
// The newer compiler proves one shift dead; the body stays byte-identical
// to the fork so it can still be diffed against it.
