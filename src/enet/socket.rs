...
use crate::enet::{Address, consts::PROTOCOL_MAXIMUM_MTU};
...
/// changed with [`Host::set_mtu`](`crate::enet::Host::set_mtu`) and
/// [`Peer::set_mtu`](`crate::enet::Peer::set_mtu`).
///
...
/// [`ReadWrite`](`crate::enet::ReadWrite`).
...
pub trait Socket: Sized {
    ...
    ///
    /// Called in [`Host::new`](`crate::enet::Host::new`). If this function returns an error, it is
    /// bubbled up through [`Host::new`](`crate::enet::Host::new`).
